                ...
                <div class="form-row">
                    <div class="col-auto my-1">
                        ...
                        <select class="custom-select mr-sm-2" id="type_object" name = "type_object">
                            <option value="{{$offer['type_object']}}"{{($offer['type_object'])?'selected':''}}>{{($offer['type_object']=='house')?'house':'flat'}}</option>
                            <option value="{{($offer['type_object']=='house')?'flat':'house'}}">{{($offer['type_object']=='house')?'flat':'house'}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <select class="custom-select mr-sm-2" name="type_price" id="type_price">
                            @foreach($prices as $prece)
                            <option value="{{$prece}}"{{($offer['type_price']==$prece)?'selected':''}}>{{$prece}}</option>
                            @endforeach
                        </select>
                        <div class="text-danger">
                            <strong>
